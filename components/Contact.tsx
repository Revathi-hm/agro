          ...
          >
            ...
            <div className="flex flex-col gap-5 mb-8">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="mailto:info@dhanalakshmiagroproducts.com" className="text-sm text-muted hover:text-forest transition-colors">
            ...
            <div className="flex gap-3">
              <a
                ...
                aria-label="WhatsApp"
                className="inline-flex items-center gap-2 px-4 py-2.5 text-sm font-semibold rounded-full border border-beige text-muted hover:text-forest hover:border-forest/30 transition-all duration-200"
              >
