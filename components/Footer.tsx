      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-10 pt-16 pb-8">
          ...
          <div>
            ...
            <ul className="flex flex-col gap-3">
              {quickLinks.map(({ label, href }) => (
                <li key={label}>
                  <a href={href} className="text-sm transition-colors hover:text-olive-lt" style={{ color: 'rgba(255,255,255,0.5)' }}>
                    {label}
                  </a>
                </li>
              ))}
        ...
        >
          <p className="text-xs" style={{ color: 'rgba(255,255,255,0.35)' }}>
            © 2025 <a href="/" className="hover:text-olive-lt transition-colors">Kalpa Ruchi</a> · Natural Goodness. All rights reserved.
          </p>
          <div className="flex gap-6">
            {['Privacy Policy', 'Terms of Use', 'Cookie Policy'].map((l) => (
              <a key={l} href="#" className="text-xs transition-colors hover:text-olive-lt" style={{ color: 'rgba(255,255,255,0.35)' }}>
                {l}
              </a>
            ))}
          </div>
